# Grade 12 — Engineering Graphics and Design (EGD) (CAPS)
...
The Engineering Graphics and Design (EGD) curriculum for Grade 12 (FET Phase) follows the South African CAPS (Curriculum and Assessment Policy Statement) guidelines.
...
In Grade 12 Engineering Graphics and Design (EGD), you will learn:
...
- Review all Engineering Graphics and Design (EGD) topics from Term 1-4
