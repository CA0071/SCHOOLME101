# Grade 2 — Sesotho Home Language (CAPS)
...
The Sesotho Home Language curriculum for Grade 2 (Foundation Phase) follows the South African CAPS (Curriculum and Assessment Policy Statement) guidelines.
...
*Listening and Speaking* is a fundamental concept in Sesotho Home Language for Grade 2.

**Understanding:**
Learners should understand the principles of listening and speaking and how they apply in various contexts.

**Application:**
This concept is applied when solving sesotho home language problems and in real-world scenarios.

### Reading and Viewing

*Reading and Viewing* is a fundamental concept in Sesotho Home Language for Grade 2.
...
*Writing* is a fundamental concept in Sesotho Home Language for Grade 2.
...
*Language Structures* is a fundamental concept in Sesotho Home Language for Grade 2.
...
Isbn: 978-1-4315-0403-9
Design and Layout by: Ndabase Printing Solution
Printed by: Government Printing Works

SESOTHO PUO YA LAPENG DIKEREITE R-3
CAPS
...
In Grade 2 Sesotho Home Language, you will learn:
...
- Review all Sesotho Home Language topics from Term 1-4
